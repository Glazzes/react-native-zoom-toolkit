...
This feature is not associated with a pan gesture, therefore it won't trigger the following callback while you pinch: `onPanStart`, `onPanEnd` and `onHorizontalBoundsExceeded`.
